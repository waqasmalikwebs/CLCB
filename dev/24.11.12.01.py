...
def generate_response(question, name="Guest", time_of_day="day", food_item=None, drink_item=None):
    ...
    question_answers = {
        ...
        "chicken": [
            f"I see you're interested in ordering a {food_item}. Would you like to add anything else?",
            f"I see you're interested in ordering a {food_item}. Would you like to add anything else 2 ?",
            f"I see you're interested in ordering a {food_item}. Would you like to add anything else 3 ?"
        ],
        "cold drink": [
            f"I see you're interested in ordering a {drink_item}. Would you like to add anything else?",
            f"I see you're interested in ordering a {drink_item}. Would you like to add anything else 2 ?",
            f"I see you're interested in ordering a {drink_item}. Would you like to add anything else 3 ?"
        ],
        "bye": [
